...
_HonkActivityModel _$HonkActivityModelFromJson(Map<String, dynamic> json) =>
    _HonkActivityModel(
      ...
      recurrenceRrule: json['recurrence_rrule'] as String?,
      recurrenceTimezone: json['recurrence_timezone'] as String,
...
Map<String, dynamic> _$HonkActivityModelToJson(_HonkActivityModel instance) =>
    <String, dynamic>{
      ...
      'recurrence_rrule': instance.recurrenceRrule,
      'recurrence_timezone': instance.recurrenceTimezone,
