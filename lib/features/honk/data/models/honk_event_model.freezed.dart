...
@override
String toString() {
  return 'HonkEventModel(id: $id, userId: $userId, location: $location, status: $status, createdAt: $createdAt, expiresAt: $expiresAt)';
}
...
class _HonkEventModel extends HonkEventModel {
  const _HonkEventModel({required this.id, required this.userId, required this.location, required this.status, required this.createdAt, required this.expiresAt}): super._();
