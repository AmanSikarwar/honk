...
@override
String toString() {
  return 'HonkParticipantModel(userId: $userId, username: $username, role: $role, effectiveStatusKey: $effectiveStatusKey, statusUpdatedAt: $statusUpdatedAt, statusExpiresAt: $statusExpiresAt)';
}
...
class _HonkParticipantModel extends HonkParticipantModel {
  const _HonkParticipantModel({required this.userId, required this.username, required this.role, required this.effectiveStatusKey, this.statusUpdatedAt, this.statusExpiresAt}): super._();
