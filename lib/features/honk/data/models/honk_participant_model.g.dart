...
_HonkParticipantModel _$HonkParticipantModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$HonkParticipantModelToJson(_HonkParticipantModel instance) =>
    <String, dynamic>{
